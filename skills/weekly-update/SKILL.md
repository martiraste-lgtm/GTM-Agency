...
- `signals/signal-library.md`
- `kpi/dashboard.md`
- `outbound/campaigns/` (campagne attive)
- `knowledge/INDEX.md`
...
- Campagne terminate → archiviare in `outbound/campaigns/archivio/`
...
- "Ci sono nuovi deal chiusi o persi da aggiornare in `knowledge/deals/`?"
...
- `signals/signal-library.md`: rimuovi segnali scaduti, aggiorna note su segnali performanti
